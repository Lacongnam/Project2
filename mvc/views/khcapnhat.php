                ...
                <div class="col-md-6 text-center">
                    ...
                    <label for="hinhanh" class="d-block border h300px w-100">
                        <button class="w-100 h-100 bg-white border-0" type="button">
                            <img src="/Project3/public/image/khachhang/<?= $khachhang[0]['hinhanh'] ?>" id="hinhanhhienthi" alt="" class="mx-100 mh-100">
                        </button>
                    </label>
                </div>
                <div class="col-sm-6    ">
                    ...
                    <div class="tt">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="/Project3/ckhachhang/thuchiencapnhattk/" class="btn btn-success mx-2">
                                <i class="fas fa-pen"></i>
                                Cập nhật</a>
                            <a href="/Project3/trangchu/" class="btn btn-primary mx-2">
                                <i class="fas fa-times"></i>
                                Thoát</a>
                            <a href="/Project3/logout.php" class="btn btn-secondary mx-2">Đăng xuất</a>
                        </div>
                    </div>
                </div>
            </div>

...
<head>
    ...
    <link rel="stylesheet" href="/Project3/public/css/chitietsp.css">
</head>
...
<body>
    ...
    <div id="header">
        ...
        include "./mvc/views/HFS/header.php";
        ?>
    </div>
    ...
    <section id="chitiet" class="content">
        ...
        <div class="container">
            ...
            <form action="/Project3/choadon/themsanphamvaogiohang" method="post">
                <div class="row mt-2">
                    <?php
                    ...
                    for ($i = 0; $i < count($data); $i++) {
                        ...
                        $soluongmacdinh = 1;
                        if ($soluongsanpham <= 0) {
                            $soluongsanpham = '<p class="text-danger my-0">Tạm hết hàng</p>';
                            $soluongmacdinh = 0;
                        }
                        echo '
                                ...
                                <div class="card border-0 mt-1 ">
                                    ...
                                    <table class="my-2 w-50" id="line-soluong">
                                        ...
                                        <div class="d-flex justify-content-end my-2">
                                            ...
                                            <a href="/Project3/ctrangchu/" class="btn btn-primary">
                                                <i class=""></i>
                                                XEM THÊM 
                                            </a>
                                        </div>
            ...
            <div class="thongtinkhac">
                <tr>
                    <td><img src="/Project3/public/image/anhlaptop/chinhhang.png" alt=""></td>
                    <td>Hàng chính hãng - bảo hành 12 tháng</td>
                </tr>
                <tr>
                    <td><img src="/Project3/public/image/anhlaptop/giaohang.png" alt=""></td>
    ...
    <div class="card uudai">
        <table class="uddb">
            ...
            <div class="ud">
                <tr>
                    <td><img src="/Project3/public/image/anhlaptop/checked.png" alt=""></td>

...
<head>
  ...
  <link rel="stylesheet" href="/Project3 /public/css/khcapnhat.css">
  <link rel="preconnect" href="https://fonts.gstatic.com">
  <link href="https://fonts.googleapis.com/css2?family=Open+Sans+Condensed:wght@300&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="/Project3/public/css/capnhattaikhoan.css">
</head>
...
<body>
  ...
  <div class="container my-4">
    <form action="/Project3/ckhachhang/capnhattaikhoan" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-6 text-center">
            ...
            <label for="hinhanh" class="d-block border h300px w-100">
              <button class="w-100 h-100 bg-white border-0" type="button" onclick="$('#hinhanh').click()">
                <img src="/Project3/public/image/khachhang/<?= $khachhang[0]['hinhanh'] ?>" id="hinhanhhienthi" alt="" class="mx-100 mh-100" title="Click vào để đổi ảnh đại diện">
              </button>
            </label>
          </div>
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-12 d-flex justify-content-end">
                <button type="submit" class="btn btn-success">
                  ...
                  Lưu</button>
                <a href="/Project3/trangchu/" class="btn btn-secondary mx-2">

...
<body>
    ...
    <div class="small-container cart-page">
            ...
            for ($i = 0; $i < count($giohang); $i++) {
                ...
                echo '
                    <tr>
                        ...
                        <td><a class="btn btn-danger" href="/Project3/choadon/xoachitiethoadon/' . $giohang[$i]['idchitiethoadon'] . '">
        ...
        <form action="/Project3/choadon/thanhtoan" method="POST">
            <div class="row">
                <div class="col-lg-6">
                    <div class="row ml-5">
                ...
                <div class="col-lg-6">
                    <div class="total-price">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <a href="/Project3/ctrangchu/" class="btn btn-outline-success">XEM THÊM</a>
                                </td>
                                <td>

...
<head>
	...
	<link rel="stylesheet" href="/Project3/public/css/quanlimt.css">
</head>	
<body>
	<div class="container-fuild" style="padding: 25px">
		<div class="panel panel-primary">
			<div class="panel-heading" >
				...
				<form autocomplete="on" action="/Project3/cmaytinh/timkiemquanli/" method="POST" style="margin-left: 150px">
					<table>
						<tr>
				...
				<button class="btn btn-success" onclick="window.open('/Project3/cquanlimt/themmt/')"><strong> Add Máy Tính</strong></button>
			</div>

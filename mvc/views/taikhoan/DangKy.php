...
<head>
    ...
    <style>
        ...
        .bg-image {
            background-image: url('/Project3/public/image/anhlaptop/anh2.jpg');
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-10 col-xl-7 mx-auto">
                                ...
                                <form method="POST" action="/Project3/ckhachhang/thuchiendangky" id="form-dangky">
                                    ...
                                    <div class="text-center d-flex justify-content-between mt-4">
                                        <p> Nếu bạn đã có tài khoản <a href="/Project3/ckhachhang/DangNhap/" class="font-italic text-muted">
                                                <u>Đăng nhập</u></a></p>
                                    </div>
                                </form>
                            </div>

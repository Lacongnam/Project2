...
<body>
   ...
   <div class="lh">
   <img src="/Project3/public/image/lh1.png" alt="">
   </div>
   <div class="title">
   	   <h1> LIÊN HỆ</h1>
...
<!--SO DIEN THOAI -->
    <div id="sdt1"> 
      <ul style="float:left;">
      	  <li> <i class="fas fa-phone-alt" style="margin-right:20px;"></i><a href="#" title="">0968175442</a></li>
          
      </ul>
      <ul>
      <li><i class="fas fa-envelope" style="margin-right:20px;"></i><a href="#" title="Email:Cntvstore@gmail.com">Email:Cntvstore@gmail.com</a></li>
      </ul>
    </div> 

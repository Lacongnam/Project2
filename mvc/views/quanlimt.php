	...
	<div class="container-fuild my-4">
		<div class="row">
			<div class="col-12 my-2">
				<div class="container">
					<div class="row d-flex align-items-center">
						<div class="col-4">
							<img class="h100px mw-100" src="/Project3/public/image/hinhlogo/logo1.png" alt="">
						</div>
			...
			<div class="col-12 my-2 d-flex justify-content-around" style="margin-left: 200px!important">
				<a href="/Project3/cquanlimt/themmt/" class="btn btn-primary" style="width:300px;">
...
<script>
	...
	function loadMaytinh() {
		$('#tb-maytinh').empty()
		$.post("/Project3/cmaytinh/getMaytinh", {}, function(data) {
					...
					<tr>
						...
						<td>
							<button class="h100px w100px border-0 bg-white">
								<img src="/Project3/public/image/anhmaytinh/${item.hinhanh}" alt="" class="mw-100 mh-100">
							</button>
						</td>
						...
						<td class="text-center">
							<a href="/Project3/cmaytinh/suathongtinmaytinh/${item.mamt}" class="btn btn-primary my-1"><i class="fas fa-pen-alt"></i> Chỉnh sửa</a>
	...
	function xoamaytinh(mamt) {
		$.post("/Project3/cmaytinh/xoamaytinh", {
			mamt: mamt
		}, function(data) {
			if (data > 0) {
	...
	$('#timkiem-btn').click(() => {
		...
		if (tensanpham.length > 0) {
			$.post('/Project3/cmaytinh/timkiemMaytinhByTenmaytinh', {

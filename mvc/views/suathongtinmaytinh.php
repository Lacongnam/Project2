...
<body>
    <div class="container my-4">
        <div class="card px-4 pb-4">
            ...
            <form action="/Project3/cmaytinh/thuchiencapnhatthongtinmaytinh" method="post" enctype="multipart/form-data">
...
<script>
    ...
    function loadLoaimaytinh() {
        $.post("/Project3/cphanloai/getPhanloai", {}, function(data) {
    ...
    function loadThongtinmaytinh() {
        ...
        $.post("/Project3/cmaytinh/getMaytinhByMamt", {
            mamt: mamt
        }, function(data) {
            dataSet = JSON.parse(data)
            mt = dataSet[0]
            ...
            $('#hienthihinhanh').append(`
                <button type="button" class="w200px h100px bg-white">
                    <img src="/Project3/public/image/anhmaytinh/${mt.hinhanh}" alt="" id="hinhanh" class="mw-100 mh-100">
                </button>
            `)
    ...
    //     $.post("/Project3/cmaytinh/thuchiencapnhatthongtinmaytinh", {
    //         mamt: mamt,

...
<script>
	...
	function loadKhachhang() {
		$.post("/Project3/ckhachhang/getKhachhang", {}, function(data) {
			...
			dataSet.forEach((item) => {
				...
				let onclick = `href='/Project3/ckhachhang/duyetkhachhang/${item.makh}'`;
				if (item.kichhoat == 1) {
					duyet = "Đã duyệt";
	...
	function hienthithongtinkhachhang(makh) {
		...
		$.post('/Project3/ckhachhang/getKhachhangByMakh', {
			makh: makh
		}, function(data) {
			...
			$('#dialog-thongtinkhachhang #hinhanh').attr('src', '/Project3/public/image/khachhang/' + khachhang['hinhanh'])
		})
	}
	...
	$('#timkiem-btn').click(() => {
		...
		if (tenkhachhang.length > 0) {
			$.post("/Project3/ckhachhang/timkiemkhachhang", {
